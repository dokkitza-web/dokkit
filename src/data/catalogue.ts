...
export const availableIndustrySlugs = new Set([
  "beauty-salons-and-spas",
  "catering-and-baking",
]);

export const featuredIndustries = industries
  .filter((industry) => availableIndustrySlugs.has(industry.slug));

export function isIndustryAvailable(slug: string) {
  return availableIndustrySlugs.has(slug);
}
