...
export const tradePacks: TradePack[] = [
  {
    ...
    samples: [
      ...
      { id: "admin-workbook", title: "Administration Workbook", description: "See a representative tracker view for clients, jobs, invoices and expenses.", format: "PNG", previewImageSrc: "/samples/trade-packs/electrical-contractor-pack/admin-workbook-sample.png", alt: "Watermarked sample administration workbook layout for the Electrical Contractor Pack" },
    ],
  },
  {
    ...
    samples: [
      ...
      { id: "admin-workbook", title: "Administration Workbook", description: "See a representative tracker view for clients, jobs, invoices and expenses.", format: "PNG", previewImageSrc: "/samples/trade-packs/plumbing-contractor-pack/admin-workbook-sample.png", alt: "Watermarked sample administration workbook layout for the Plumbing Contractor Pack" },
    ],
  },
  {
    ...
    samples: [
      ...
      { id: "admin-workbook", title: "Administration Workbook", description: "See a representative tracker view for clients, jobs, invoices and expenses.", format: "PNG", previewImageSrc: "/samples/trade-packs/solar-installer-pack/admin-workbook-sample.png", alt: "Watermarked sample administration workbook layout for the Solar Installer Pack" },
    ],
  },
  {
    ...
    samples: [
      ...
      { id: "admin-workbook", title: "Administration Workbook", description: "See a representative tracker view for clients, jobs, invoices and expenses.", format: "PNG", previewImageSrc: "/samples/trade-packs/electric-fence-installer-pack/admin-workbook-sample.png", alt: "Watermarked sample administration workbook layout for the Electric Fence Installer Pack" },
    ],
  },
];
